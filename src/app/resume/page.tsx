  ...
  return (
    <>
      ...
      <div className="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
        ...
        <h3>Frontend Engineer, NAVER Financial Corp.</h3>
        <p>
          <strong>2020.09 ~ 현재</strong>
        </p>
        <ul>
          ...
          <li>React, Next.js, K8S, Koa를 기반으로 모바일 지향 서비스 개발</li>
        ...
        <p>
          주요 언어 및 기술: React, TypeScript, JavaScript, MobX, Next.js, SCSS,
          react-query, SWR, styled-components, Koa, K8S, Rollup, esbuild, Vite,
          pnpm/npm workspaces, Turborepo
        </p>
        <h3>Frontend Engineer, Triple Corp.</h3>
        <p>
          <strong>2019.05 ~ 2020.08</strong>
        </p>
        <ul>
          <li>트리플 애플리케이션 프론트엔드 서비스 개발</li>
          <li>
            JavaScript로 작성된 결제 서비스 및 공통 컴포넌트를 TypeScript로 변환
          </li>
        ...
        <h3>Software Engineer, Kakao Corp.</h3>
        <p>
          <strong>2016.09 ~ 2019.05</strong>
        </p>
        <ul>
          <li>
        ...
        <p>
          주요 언어 및 기술: Angular, AngularJS, JavaScript, TypeScript, Ruby on
          Rails, MySQL, Redis
        </p>
        <h3>Software Engineer, Samsung SDS</h3>
        <p>
          <strong>2014.03 ~ 2016.06</strong>
        </p>
        <ul>
          ...
          <li>
            실내 내비게이션 시스템 POC - iOS 기반 비콘 위치 추적 애플리케이션
            개발
          </li>
          <li>Python을 활용한 데이터 정합성 및 유효성 계산</li>
          <li>
            블록체인 시스템 POC - 금융 고객사를 위한 블록체인 시스템 POC 개발
          </li>
          <li>Custom blockchain, JavaScript, HTML, CSS</li>
        </ul>
        <h2>Education</h2>
        <h3>한국과학기술원 (KAIST) 대전캠퍼스</h3>
        <p>
          <strong>2018.03 ~ 2020.02</strong>
        </p>
        <p>기술경영전문대학원 석사과정 졸업 (Highest Honor, GPA 4.23 / 4.3)</p>
        <h3>동국대학교 서울캠퍼스</h3>
        <p>
          <strong>2007.03 ~ 2014.02</strong>
        </p>
        <p>국제통상학 전공, 영어통번역학 복수전공 학사과정 졸업</p>
        <h2>Extra-Curricular Activities</h2>
        <h3>Jump Board Member</h3>
        <p>
          <strong>2016.03 ~ 현재</strong>
        </p>
        <p>
          <a href="https://jumpsp.org/">점프</a> 이사로 활동하며 Google Cloud
          Platform을 활용해 업무 자동화 및 프로그래밍 교육을 담당하고 있습니다.
        </p>
        <p>
          주요 언어 및 기술: React, Next.js, Node.js, Vercel, Google Firebase,
        ...
        <h3>Samsung Software Academy For Youth (SSAFY) 멘토</h3>
        <p>
          <strong>2021.01 ~ 2021.12</strong>
        </p>
        <p>
