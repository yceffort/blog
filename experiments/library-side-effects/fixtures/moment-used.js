...
;(() => {
  ...
  var Ri = (v, o) => () => (o || v((o = {exports: {}}).exports, o), o.exports)
  var Fi = (v, o, V, b) => {
    if ((o && typeof o == 'object') || typeof o == 'function')
      for (let N of Ni(o))
        !Pi.call(v, N) &&
          ...
          Ys(v, N, {
            get: () => o[N],
            enumerable: !(b = xi(o, N)) || b.enumerable,
          })
    return v
  }
  var Ci = (v, o, V) => (
...
` +
      ...
      function xe(e, t) {
        return e.isValid()
          ? ((t = Rt(t, e.localeData())), (rt[t] = rt[t] || Rs(t)), rt[t](e))
      ...
      function zs(e) {
        var t = [],
          s
        for (s in e) w(e, s) && t.push({unit: s, priority: js[s]})
        return (
          t.sort(function (r, a) {
      ...
      function qs(e, t) {
        return w(Ce, e) ? Ce[e](t._strict, t._locale) : new RegExp(Bs(e))
      }
      function Bs(e) {
        return j(
          e
      ...
      function ur(e, t, s) {
        var r, a, n
        if (this._monthsParseExact) return lr.call(this, e, t, s)
        for (
          this._monthsParse ||
            ((this._monthsParse = []),
            (this._longMonthsParse = []),
      ...
      function hr(e) {
        return this._monthsParseExact
          ...
          : (w(this, '_monthsShortRegex') || (this._monthsShortRegex = ar),
      ...
      function fr(e) {
        return this._monthsParseExact
          ...
          : (w(this, '_monthsRegex') || (this._monthsRegex = nr),
      ...
      var Dr = 'Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday'.split(
          '_',
        ),
      ...
      function Cr(e) {
        return this._weekdaysParseExact
          ...
          : (w(this, '_weekdaysRegex') || (this._weekdaysRegex = Yr),
      ...
      function Lr(e) {
        return this._weekdaysParseExact
          ...
          : (w(this, '_weekdaysShortRegex') || (this._weekdaysShortRegex = pr),
      ...
      function Ur(e) {
        return this._weekdaysParseExact
          ...
          : (w(this, '_weekdaysMinRegex') || (this._weekdaysMinRegex = Or),
      ...
      function jr(e) {
        for (var t = 0, s, r, a, n; t < e.length;) {
          for (
            ...
            if (r && r.length >= s && Gr(n, r) >= s - 1) break
            s--
          }
          t++
        }
      ...
      function Ie(e) {
        var t = null,
          s
        if (D[e] === void 0 && typeof _e < 'u' && _e && _e.exports && zr(e))
          try {
      ...
      function mt(e) {
        ...
        return (
          s &&
            ...
            c(e)._overflowWeeks && t === -1 && (t = Qs),
            c(e)._overflowWeekday && t === -1 && (t = Xs),
            (c(e).overflow = t)),
          e
        )
      }
      ...
      function Kt(e) {
        var t = Xr.exec(sa(e._i)),
          s
        if (t) {
          if (((s = ea(t[4], t[3], t[2], t[5], t[6], t[7])), !ra(t[1], s, e)))
            return
          ;((e._a = s),
            (e._tzm = aa(t[8], t[9], t[10])),
      ...
      function yt(e) {
        ...
        if (!e._d) {
          for (
            a = ia(e),
              e._w && e._a[A] == null && e._a[z] == null && oa(e),
              e._dayOfYear != null &&
                ((i = de(e._a[O], a[O])),
                (e._dayOfYear > ge(i) || e._dayOfYear === 0) &&
          ...
          ;(e._a[p] === 24 &&
            ...
            (e._d = (e._useUTC ? De : cr).apply(null, r)),
      ...
      function wt(e) {
        ...
        ;((c(e).charsLeftOver = u - f),
          ...
          (e._a[p] = la(e._locale, e._a[p], e._meridiem)),
          (_ = c(e).era),
        ...
        return (
          ...
          t === null || (s === void 0 && t === '')
            ...
            : (typeof t == 'string' && (e._i = t = e._locale.preparse(t)),
              C(t)
                ? new we(mt(t))
                : (ye(t) ? (e._d = t) : b(s) ? ua(e) : s ? wt(e) : fa(e),
                  Je(e) || (e._d = null),
                  e))
        )
      }
      ...
      function va(e, t, s) {
        ...
        if (e != null) {
          if (typeof e == 'string') {
            if (((e = Mt(Fe, e)), e === null)) return this
        ...
        return (
          ...
          e._a
            ? ((t = e._isUTC ? I(e._a) : S(e._a)),
              (this._isDSTShifted =
                this.isValid() && Sa(e._a, t.toArray()) > 0))
      ...
      function _s(e, t, s, r, a) {
        ...
        return e == null
          ? ve(this, r, a).year
          : ((n = $(e, r, a)), t > n && (t = n), In.call(this, e, t, s, r, a))
      }
      ...
      for (te = 'S'; te.length <= 9; te += 'S') M(te, Gn)
      ...
      ;((l.add = La),
        ...
        (l.weekYear = Pn),
        (l.isoWeekYear = Rn),
        (l.quarter = l.quarters = Hn),
        (l.month = jt),
        (l.daysInMonth = dr),
        (l.week = l.weeks = kr),
        (l.isoWeek = l.isoWeeks = Mr),
        (l.weeksInYear = Ln),
        (l.weeksInWeekYear = Un),
        (l.isoWeeksInYear = Fn),
        (l.isoWeeksInISOWeekYear = Cn),
        (l.date = ys),
        (l.day = l.days = Pr),
        (l.weekday = Rr),
        (l.isoWeekday = Fr),
      ...
      ;((k.calendar = Ws),
        ...
        (k.eras = Mn),
        (k.erasParse = gn),
        (k.erasConvertYear = Sn),
        (k.erasAbbrRegex = Tn),
        (k.erasNameRegex = On),
        (k.erasNarrowRegex = bn),
        (k.months = ir),
        (k.monthsShort = or),
        (k.monthsParse = ur),
        (k.monthsRegex = fr),
        (k.monthsShortRegex = hr),
        (k.week = mr),
        (k.firstDayOfYear = wr),
        (k.firstDayOfWeek = yr),
        (k.weekdays = Tr),
        ...
        (k.weekdaysParse = Wr),
        (k.weekdaysRegex = Cr),
        (k.weekdaysShortRegex = Lr),
        (k.weekdaysMinRegex = Ur),
        (k.isPM = Hr),
        (k.meridiem = Vr))
      function Ze(e, t, s, r) {
        var a = q(),
      ...
      return (
        ...
        (o.weekdaysShort = Qn),
        (o.normalizeUnits = R),
        (o.relativeTimeRounding = pi),
        (o.relativeTimeThreshold = Oi),
        (o.calendarFormat = Va),
        (o.prototype = l),
        (o.HTML5_FMT = {
  ...
  var Ts = Ci(Os(), 1)
  globalThis.__libResult = (0, Ts.default)(0).format('YYYY-MM-DD')
