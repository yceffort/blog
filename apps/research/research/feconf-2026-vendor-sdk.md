...
_다음 사례는 리다이렉트 엔트리를 검증하다 만난, SDK가 바꾼 브라우저 상태 이야기입니다_
...
지금부터 볼 사례도 브라우저 동작에서 시작합니다. SDK가 history를 패치하면 그 흔적은 페이지뿐 아니라 테스트가 쓰는 브라우저 환경에도 남습니다. URL에 따라 리다이렉트하는 엔트리를 검증하다가 발견했습니다.
-->
