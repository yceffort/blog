...
description: "I don't know what the future holds, but shouldn't we just keep developing diligently?"
---

## Table of Contents

> - The following is a blog post adapted from a question I received from a developer and my email response.
> - This post was NOT written by AI 😄

These days, barely a day goes by without various blogs, articles, and videos flooding us with stories about AI, MCP (a protocol for AI to integrate with external tools), Agent-to-Agent autonomous collaboration, and countless other technological developments. From my perspective as a developer, about half of the articles I see are promoting the latest technologies with messages like "productivity dramatically improved after adopting AI technology," while the other half seem to create a sense of fear and tension with headlines like "big tech companies are now laying off developers en masse."

This trend isn't entirely welcome for non-AI developers like myself. These technological advances bring structural changes that are difficult to keep up with through individual effort alone, accompanied by concerns about employment market instability. When we see so-called "vibe coders" with no development background saying "I built this level of service without knowing anything about development," we might look at it dismissively, thinking "is it okay to build such an unpolished service?" But beneath that, we all probably have some anxiety that what we do might be replaced by AI someday, or in the not-so-distant future.
...
I don't think our workload will decrease just because AI helps improve development efficiency. This might actually align with [Jevons Paradox](https://en.wikipedia.org/wiki/Jevons_paradox). Just as increased efficiency in a particular technology lowers the cost of using that technology, ultimately increasing total consumption of that resource.
...
- [Jevons Paradox - Wikipedia (Korean)](https://ko.wikipedia.org/wiki/%EC%A0%9C%EB%B3%B8%EC%8A%A4%EC%9D%98_%EC%97%AD%EC%84%A4)
