...
export default function HeroFxA() {
  ...
  return (
    <div
      ref={wrapRef}
      className={`hero-fx-canvas ${aboutStyles.hero_fx_canvas}`}
    >
      <Canvas
        dpr={[1, 1.8]}
        camera={{
      ...
      <div
        className={`hero-fx-hint hero-fx-hint-desktop ${aboutStyles.hero_fx_hint} ${aboutStyles.hero_fx_hint_desktop}`}
      >
        hover to scatter
      </div>
      <div
        className={`hero-fx-hint hero-fx-hint-touch ${aboutStyles.hero_fx_hint} ${aboutStyles.hero_fx_hint_touch}`}
      >
        tap and hold
      </div>
    </div>
